    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerGenre", x => new { x.GenreId, x.CustomerId });
                    table.ForeignKey(
                        name: "FK_CustomerGenre_AppCustomers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "AppCustomers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerGenre_Genre_GenreId",
                        column: x => x.GenreId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Order_AppCustomers_AppCustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerGenre_CustomerId",
                table: "CustomerGenre",
                column: "CustomerId");
